 ...
 * based on this packet's RTT.  I calculate the RTT, then update the
...
rtt_stop(struct rtt_info *ptr, uint32_t ms)
{
	 ...
	 * I use floating point here for simplicity.
	 */
...
// In function rtt_timeout (Fig. 22.14), after doubling the
// mRTO in line 86, pass its value through the function rtt_minmax of
// Fig. 22.11 (somewhat along the lines of what is done in line 77
// of rtt_stop, Fig. 22.13).
int
